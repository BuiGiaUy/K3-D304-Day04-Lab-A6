...
TOOL_FUNCTIONS = {
    ...
    # Tool mới do nhóm A6 viết. Declaration trong artifacts/tools.yaml được thêm ở
    # v2 — v1 cố ý giữ tools.yaml nguyên vẹn để đo riêng tác động của system prompt.
    "dedupe": dedupe_items,
}
